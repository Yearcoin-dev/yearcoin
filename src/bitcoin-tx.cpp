...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yearcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yearcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yearcoin transaction") + "\n" +
              "  yearcoin-tx [options] -create [commands]   " + _("Create hex-encoded yearcoin transaction") + "\n" +
              "\n";
