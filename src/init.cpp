...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/yearcoin-project/yearcoin>";
    const std::string URL_WEBSITE = "<https://yearcoin.org>";
